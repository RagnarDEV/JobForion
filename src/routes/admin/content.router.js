...
import { getPageBySlug, createPage, updatePage, deletePage, movePage } from '../../lib/content/pages-cms.js';
import { createNavButton, deleteNavButton } from '../../lib/content/nav-buttons.js';
import { getPostById, createPost, updatePost, deletePost } from '../../lib/content/blog-cms.js';
...
export async function handleAdminContentRoute(url, request, env, base) {
  ...
  // ── Custom menu buttons (see lib/content/nav-buttons.js) — managed from the
