...
//
// Every POST here is rate-limited (lib/platform/rate-limit.js — the same D1-backed
...
import { findUserByEmail, createUser, verifyCredentials, markEmailVerified, updateUserPassword } from '../lib/accounts/users.js';
