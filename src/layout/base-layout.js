...
import { SETTINGS_DEFAULTS, themeCssVariables } from '../lib/platform/settings.js';
...
//
// `settings` (optional) is the resolved object from lib/platform/settings.js —
...
// lib/content/categories.js — pass it to get the live, admin-managed category
...
// `footerPages` (optional, new) is the array from lib/content/pages-cms.js's
