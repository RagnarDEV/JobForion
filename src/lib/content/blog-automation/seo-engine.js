// src/lib/content/blog-automation/seo-engine.js
...
// exactly one place, matching the pattern lib/seo/meta.js already sets for the
// rest of the site (truncateDescription, buildMeta).

import { slugify } from '../../directory/entities.js';
