// src/lib/jobs/job-alerts-dispatcher.js
// ════════════════════════════════════════════════════════════════
// JOB ALERTS DISPATCHER — the piece that was missing: job_alerts rows
// were being created and stored (lib/jobs/job-alerts.js) but nothing ever
...
import { logActivity } from '../platform/activity-log.js';
import { escapeHtml } from '../directory/entities.js';
