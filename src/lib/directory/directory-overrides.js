// src/lib/directory/directory-overrides.js
// ════════════════════════════════════════════════════════════════
...
// the top of lib/directory/entities.js: location is unstructured text like
...
// where name is the EXACT raw string lib/directory/entities.js would otherwise
// display. Both are applied inside listCountries()/listCities()/
// listSkills() in lib/directory/entities.js, so every caller (public directory
...
// lib/platform/settings.js / lib/content/categories.js), cleared on any write below.
