...
// manual /admin/directory override system (lib/directory/directory-overrides.js) —
...
// falls through to the original heuristic (see lib/directory/entities.js's
