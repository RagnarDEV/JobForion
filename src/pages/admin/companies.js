...
// listCompanies() in lib/directory/entities.js — homepage facet panel, sitemap)
...
import { iconBuilding } from '../../assets/icons.js';
const PAGE_SIZE = 40;
...
export async function renderCompaniesListContent(env, params) {
  ...
  // Deliberately NOT using lib/directory/entities.js's listCompanies() here — that
  ...
  <div class="adm-wrap">
    <div class="adm-hdr">
      <div>
        <div class="adm-title">${iconBuilding({ size: 22 })} Company Management</div>
