...
// lib/platform/settings.js. This is the first concrete proof of the "no settings
...
import { getSettings, SETTINGS_DEFAULTS, THEME_DEFAULTS, COMPONENT_DEFAULTS, HOMEPAGE_COPY_DEFAULTS, HERO_FONT_OPTIONS } from '../../lib/platform/settings.js';
import { salaryTierBadgeHtml } from '../../components/job-card.js';

import { iconFlame, iconPalette, iconSettingsGear } from '../../assets/icons.js';
...
// convention as maintenance_mode/ads_enabled — see lib/platform/settings.js —
...
export async function renderSettingsContent(env) {
  ...
  <div class="adm-wrap" style="max-width:820px">
    <div class="adm-hdr">
      <div>
        <div class="adm-title">${iconSettingsGear({ size: 22 })} Settings</div>
    ...
    <form method="POST" action="/admin/settings/update" style="display:flex;flex-direction:column;gap:16px">
      ...
      <div class="adm-card" id="settings-hero">
        <div class="adm-card-title">${iconPalette({ size: 16 })} Hero &amp; Branding <span style="font-weight:400;color:var(--ink3);font-size:12px">— the homepage banner (title, search bar, font; colors use Appearance Theme)</span></div>
      ...
      <div class="adm-card">
        <div class="adm-card-title">${iconPalette({ size: 16 })} Appearance Theme <span style="font-weight:400;color:var(--ink3);font-size:12px">— validated Design System tokens used across the public site</span></div>
      ...
      <div class="adm-card">
        <div class="adm-card-title">${iconFlame({ size: 16 })} HOT PAY <span style="font-weight:400;color:var(--ink3);font-size:12px">— high-salary job indicator</span></div>
