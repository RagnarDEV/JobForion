...
// lib/platform/rate-limit.js), and honest documentation of how password rotation
...
import { getRecentActivity, countRecentLoginFailures, ACTION_LABELS } from '../../lib/platform/activity-log.js';

import { iconAlertTriangle, iconShieldCheck } from '../../assets/icons.js';
export async function renderSecurityContent(env) {
  ...
  <div class="adm-wrap">
    <div class="adm-hdr">
      <div>
        <div class="adm-title">${iconShieldCheck({ size: 22 })} Admin &amp; Security</div>
    ...
    <div class="adm-grid" style="margin-bottom:16px">
      ...
      <div class="adm-card">
        ...
        ${failedLogins > 3
          ? `<div style="font-size:11px;color:var(--coral);margin-top:10px">${iconAlertTriangle({ size: 15 })} Repeated failed attempts detected. The rate limiter is actively slowing these down (max 5 / 15 min per IP) — if this continues, rotate the password using the command above.</div>`
