...
@media(max-width:480px){.dashboard-page .dashboard-kpi-grid{grid-template-columns:1fr 1fr}.dashboard-page .dashboard-kpi-value{font-size:23px!important}.dashboard-page .dashboard-kpi-sub{font-size:9.5px!important}.dashboard-page .dashboard-pulse{padding:9px 8px}.dashboard-page .dashboard-pulse strong{font-size:12px}.dashboard-page .dashboard-pulse span,.dashboard-page .dashboard-pulse small{font-size:8.5px}.dashboard-page .dashboard-actions{width:100%}.dashboard-page .dashboard-actions .adm-btn{flex:1;min-width:0;padding-left:8px;padding-right:8px;font-size:10px}.dashboard-page .dashboard-header-meta{font-size:9.5px}.dashboard-page .dashboard-bar-row{grid-template-columns:minmax(62px,78px) minmax(0,1fr) 32px;gap:6px}.dashboard-page .dashboard-bar-label{font-size:9px}.dashboard-page .dashboard-bar-value{font-size:10px}}
</style>`;
