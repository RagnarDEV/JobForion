...
// Countries / Cities / Skills management — see lib/directory/directory-overrides.js
...
import { escapeHtml, listCountriesRaw, listCitiesRaw, listSkillsRaw } from '../../lib/directory/entities.js';
import { getOverrides } from '../../lib/directory/directory-overrides.js';

import { iconBuilding, iconGlobe, iconTag } from '../../assets/icons.js';
const SECTIONS = [
  { kind: 'country', title: `${iconGlobe({ size: 15 })} Countries`, param: 'country_q', rawFn: listCountriesRaw },
  { kind: 'city', title: `${iconBuilding({ size: 15 })} Cities`, param: 'city_q', rawFn: listCitiesRaw },
  { kind: 'skill', title: `${iconTag({ size: 15 })} Skills`, param: 'skill_q', rawFn: listSkillsRaw },
];
...
export async function renderDirectoryContent(env, params) {
  ...
  <div class="adm-wrap" style="max-width:820px">
    <div class="adm-hdr">
      <div>
        <div class="adm-title">${iconGlobe({ size: 22 })} Directory</div>
