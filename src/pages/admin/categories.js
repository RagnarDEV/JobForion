...
// delete — the concrete UI on top of lib/content/categories.js. Every category
...
function categoryCard(cat, idx, total, jobCount) {
  ...
  return `<div class="cat-card">
    <div class="cat-card-icon" style="background:${swatch}1a;color:${swatch}">${cat.emoji ? escapeHtml(cat.emoji) : iconTag({ size: 18 })}</div>
...
export async function renderCategoriesContent(env) {
  ...
  <div class="adm-wrap" style="max-width:820px">
    <div class="adm-hdr">
      <div>
        <div class="adm-title">${iconFolder({ size: 22 })} Categories</div>
