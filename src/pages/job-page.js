...
import { iconBadgeCheck, iconSparkle, iconFlame, iconDollarSign, iconArrowRight, iconBookmark, iconTrendingUp, iconBuilding, iconBriefcase, iconClock, iconGlobe } from '../assets/icons.js';
...
export async function renderJobPage(job, related, base, env, user = null) {
  ...
  const content = `
<div class="page">
  <div class="job-mobile-topbar"><a href="/jobs" aria-label="Back to jobs">←</a><strong>Job Details</strong><span aria-hidden="true"></span></div>
