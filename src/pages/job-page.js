...
import { slugify, escapeHtml, safeExternalUrl, cleanDescription, parseSalaryRange, categorySalaryStats, companySnapshot } from '../lib/directory/entities.js';
import { adSlot } from '../components/ad-slot.js';
import { jobPostingSchema } from '../lib/seo/jsonld.js';
...
import { getVerifiedCompanyNameSet, getPublicCompanyBySlug } from '../lib/companies/companies.js';
...
// ONE place — lib/seo/jsonld.js's jobPostingSchema() — instead of being
...
// ════════════════════════════════════════════════════════════════
// ORIGINAL-CONTENT BOXES — see the matching helpers in lib/directory/entities.js
...
export async function renderJobPage(job, related, base, env, user = null) {
  ...
  // Custom logo overrides (see /admin/companies to lib/companies/company-logos.js) —
