...
export async function renderMainHTML(env, base, user = null) {
  ...
  const sectionHtml = {
    ...
    <section class="fc-strip">
      <div class="fc-inner"><div class="section-heading compact-heading"><div><p class="eyebrow">CURATED EMPLOYERS</p><h2>${escapeHtml(homepageCopy.featuredTitle)}</h2></div><a class="text-button" href="/companies">View all companies</a></div>
...
.cg-title{font-family:var(--font-heading,sans-serif);font-size:15px;font-weight:800;color:var(--ink);margin-bottom:12px}
...
.cta-title{font-family:var(--font-heading,sans-serif);font-size:19px;font-weight:800;color:#fff;margin-bottom:4px}
