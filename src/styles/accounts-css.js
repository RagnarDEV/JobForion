...
.auth-title{font-family:var(--font-heading,sans-serif);font-size:22px;font-weight:800;color:var(--ink);margin-bottom:6px}
...
.dash-title{font-family:var(--font-heading,sans-serif);font-size:22px;font-weight:800;color:var(--ink)}
...
.dash-kpi-val{font-family:var(--font-heading,sans-serif);font-size:24px;font-weight:800;color:var(--brand)}
