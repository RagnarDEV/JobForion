import { readApiSource, readHomeSource } from './helpers/read-source.mjs';
import assert from 'node:assert/strict';
import fs from 'node:fs';
import { parseSalary } from '../src/lib/jobs/salary.js';
import { classifySalary } from '../src/lib/jobs/salary-tier.js';
import { isHotPayJob, annotateHotPay } from '../src/lib/jobs/hot-pay.js';
