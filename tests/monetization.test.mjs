import { readApiSource } from './helpers/read-source.mjs';
...
} from '../src/lib/monetization/core.js';
...
const serviceSource = fs.readFileSync(new URL('../src/lib/monetization/core.js', import.meta.url), 'utf8');
...
const settingsSource = fs.readFileSync(new URL('../src/lib/platform/settings.js', import.meta.url), 'utf8');
const cmsSource = fs.readFileSync(new URL('../src/lib/content/pages-cms.js', import.meta.url), 'utf8');
